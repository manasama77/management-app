                ...
                <form class="flex flex-col gap-4" onsubmit="event.preventDefault(); comingSoon()">
                    <fieldset class="fieldset">
                        ...
                        <input type="text" name="no_project" class="input" placeholder="No Project"
                            wire:model.live.debounce="no_project" />
                        @error('no_project')
                    ...
                    <fieldset class="fieldset">
                        ...
                        <input type="text" name="nama_project" class="input" placeholder="Nama Project"
                            wire:model.live.debounce="nama_project" />
                        @error('nama_project')
                            <p class="label text-error">{{ $message }}</p>
                        @enderror
                    </fieldset>
                    <fieldset class="fieldset">
                        ...
                        <input type="text" name="client" class="input" placeholder="Client"
                            wire:model.live.debounce="client" />
                        @error('client')
                            <p class="label text-error">{{ $message }}</p>
                        @enderror
                    </fieldset>
                    ...
                    <fieldset class="fieldset">
                        ...
                        <select name="pic" class="select" wire:model.live.debounce="pic">
